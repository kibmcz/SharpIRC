...
namespace SharpIRC {
    ...
    public class Program {
        ...
        public static void LoadPlugins() {
            AddinManager.Initialize("[ApplicationData]/SharpIRC");
            ...
            foreach (var attribute in AppDomain.CurrentDomain.GetAssemblies().SelectMany(assembly => assembly.GetCustomAttributes(typeof (PluginInfoAttribute), false).Cast<PluginInfoAttribute>())) {
                Comment(String.Format("Loaded Plugin: \"{0}\" by {1}. Version: {2} ", attribute.Name, attribute.Description, attribute.Version));
            }
