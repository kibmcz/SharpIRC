...
namespace SharpIRC.API {
    ...
    public class Commands {
        ...
        /// <param name="reciever">The channel or user to send to.</param>
        /// <param name="message">The message to send.</param>
        public static void SendAction(IRCConnection connection, Channel reciever, string message) { Connect.SendToServer(connection, String.Format("PRIVMSG {0} :{1}ACTION {2}{1}", reciever.Name, (char)1, message)); }
        ...
        /// <param name="connection">IRC Connection to join on.</param>
        /// <param name="channel">The name of the channel to join.</param>
        public static void SendJoin(IRCConnection connection, Channel channel) { Connect.SendToServer(connection, "JOIN " + channel.Name); }
        ...
        /// <param name="channel">The channel to leave.</param>
        /// <param name="message">Optional message to display in the Part.</param>
        public static void SendPart(IRCConnection connection, Channel channel, string message) { Connect.SendToServer(connection, "PART " + channel.Name + " :" + message); }
        ...
        /// <param name="channel">The channel to leave.</param>
        /// <param name="newtopic">The contents of the new topic.</param>
        public static void SendTopic(IRCConnection connection, Channel channel, string newtopic) { Connect.SendToServer(connection, "TOPIC " + channel.Name + " :" + newtopic); }
        ...
        /// <param name="channel">The channel to modify.</param>
        /// <param name="message">The modes to change. (Standard +mode-mode format)</param>
        public static void SendModes(IRCConnection connection, Channel channel, string message) { Connect.SendToServer(connection, "MODE " + channel.Name + " " + message); }
